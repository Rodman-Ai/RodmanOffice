...
//  bottom-left of the page (Y grows upward). RodmanDiagrams uses
//  page-local pixels with origin at the top-left. We convert via
//  PX_PER_IN (96) plus a Y-flip against the page height.
//
//  READS a VSDX and produces a Diagram shaped like RodmanDiagrams'
...
function buildAppXml(pageCount) {
  return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>` +
    `<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties">` +
      `<Application>RodmanDiagrams</Application>` +
...
/**
 * Build a VSDX Blob from a RodmanDiagrams diagram.
